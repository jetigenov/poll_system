...
from poll_system.models import Poll, Question, Answer, Choice
from poll_system.serializers import (PollSerializer, QuestionSerializer, AnswerSerializer,
                                     UserPollSerializer, AnswerOneTextSerializer, AnswerOneChoiceSerializer,
                                     AnswerMultipleChoiceSerializer, ChoiceSerializer)
...
class ChoiceViewSet(viewsets.ModelViewSet):
    ...
    def perform_create(self, serializer):
        question = get_object_or_404(Question, pk=self.kwargs['question_pk'], poll__id=self.kwargs['id'],)
